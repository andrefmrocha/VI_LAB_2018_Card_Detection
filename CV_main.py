...
list_card, list_camera, list_labels = gen_data(x_Card, x_Camera, 3)
...
base_network, opt = create_base_network(input_shape,4,4)
...
cnn_model.fit(x=[x_Train["card"], x_Train["camera"]], y=y_Train, epochs=50,
